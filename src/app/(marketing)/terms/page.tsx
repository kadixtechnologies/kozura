        ...
        <div className="bg-background rounded-[32px] md:rounded-[48px] border border-border/60 p-8 md:p-16 shadow-sm animate-in fade-in zoom-in-95 duration-700 delay-150 fill-mode-both">
          ...
          <section id="terms" className="scroll-mt-32">
            ...
            <p className="text-muted-foreground leading-relaxed mb-8 text-lg">
              Welcome to Kozura. By accessing or using our platform, you agree
              to be bound by these terms. We provide a digital storefront
              solution that allows sellers to easily display products and
              receive orders via WhatsApp.
            </p>

            <h3 className="text-xl font-bold mb-4 text-foreground mt-8">
              Use of our platform
            </h3>
            <p className="text-muted-foreground leading-relaxed mb-8">
              Kozura grants you a limited, non-exclusive, non-transferable, and
              revocable license to use our services for your business. You agree
            ...
            <p className="text-muted-foreground leading-relaxed mb-12">
              ...
              account. Kozura cannot and will not be liable for any loss or
          ...
          <section id="prohibited" className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              When using Kozura, you agree not to engage in any of the following
              activities:
            </p>
            <ul className="list-disc pl-6 space-y-3 text-muted-foreground marker:text-primary/70">
              ...
              <li>
                Fraudulent activities, including selling fake or illegal
                products.
              </li>
              <li>
                Violation of applicable local, state, national, or international
                laws.
              </li>
              <li>
                Unauthorized access, interference, or disruption of our servers
                or networks.
              </li>
            </ul>
          </section>
          ...
          <section id="privacy" className="scroll-mt-32">
            ...
            <p className="text-muted-foreground leading-relaxed mb-8 text-lg">
              Your privacy is extremely important to us. This section explains
              how we collect, use, and protect your personal data when you
              interact with the Kozura platform.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              ...
              your name, email address, store name, and WhatsApp number. We use
              this information solely to provide, maintain, and improve our
            ...
            <ul className="list-disc pl-6 space-y-3 text-muted-foreground mb-12 marker:text-primary/70">
              ...
              <li>
                ...
                navigate the platform and to improve performance.
              </li>
              <li>
                <strong>Optional tracking:</strong> Tracking cookies for
                tailored marketing (which you can opt out of).
              </li>
            </ul>
          </section>
          ...
          <section id="policy" className="scroll-mt-32">
            ...
            <p className="text-muted-foreground leading-relaxed mb-8 text-lg">
              This policy outlines the expected behavior for all users on the
              Kozura platform to ensure a safe and trustworthy environment for
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              All interactions between sellers and buyers must remain
              professional and respectful. Sellers must accurately represent
              their products, fulfill orders promptly, and handle customer
              inquiries with integrity.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Kozura reserves the right to suspend or terminate accounts that
              violate our terms, engage in fraudulent behavior, or receive
              consistent negative reports from buyers. In the event of a
              suspension, the seller will be notified via email with details
            ...
            <div className="flex items-center gap-6 text-white/60">
              ...
              >
                <svg
                  ...
                  fill="currentColor"
                >
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 2.23-1.11 4.46-2.9 5.81-1.78 1.34-4.14 1.83-6.28 1.4-2.14-.44-4.04-1.85-5.07-3.78-1.04-1.94-1.16-4.32-.34-6.32.81-1.99 2.5-3.59 4.54-4.25 2.03-.65 4.3-.49 6.2.5.01 1.42.02 2.84 0 4.26-1.17-.67-2.6-.96-3.92-.61-1.32.34-2.42 1.35-2.92 2.6-.51 1.25-.36 2.72.39 3.84.75 1.13 2.1 1.79 3.48 1.75 1.37-.03 2.65-.77 3.33-1.96.67-1.18.89-2.61.85-3.97.02-4.96.02-9.92 0-14.88z" />
                </svg>
              </Link>
              <Link
                href="#"
